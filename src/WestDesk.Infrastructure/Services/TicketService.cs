...
using WestDesk.Application.DTOs.Tickets;
...
public class TicketService : ITicketService
{
    ...
    public TicketService(WestDeskDbContext context, IConnectionMultiplexer redis, IEmailService emailService, IAIService aiService, IHubContext<TicketHub> hubContext)
    {
        _context = context;
        _redis = redis;
